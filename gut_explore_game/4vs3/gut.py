...
def second_level_mne(e, a, strategyProbablity):
    for s in range(len(strategyProbablity)):
        if s == 0:
            e['triangle'] = strategyProbablity[s]
        elif s ==1:
            e['diamond'] = strategyProbablity[s]
        elif s == 2:
...
def HPUtility(numAttackingAgent, numAttackingAdversary, agent_hp_level, explorerStrategy, alienStrategy):
    ...
    if explorerStrategy == 'triangle' and alienStrategy == 'follow':
        explorerArea = agentArea * 1.5
        alienArea = agentArea * 1.2
    elif explorerStrategy == 'triangle' and alienStrategy == 'back':
        explorerArea = agentArea * 1.5
        alienArea = agentArea * 0.8
    elif explorerStrategy == 'diamond' and alienStrategy == 'follow':
        explorerArea = agentArea * 0.8
        alienArea = agentArea * 1.2
    elif explorerStrategy == 'diamond' and alienStrategy == 'back':
        explorerArea = agentArea * 0.8
        alienArea = agentArea * 0.8
...
def GUT_DecisionMaking(numExplorer, numActiveAlien, agent_energy_level, agent_hp_level):
    ...
    x11 = round(HPUtility(numExplorer, numActiveAlien, agent_hp_level, 'triangle', 'follow'))
    x12 = round(HPUtility(numExplorer, numActiveAlien, agent_hp_level, 'triangle', 'back'))
    x21 = round(HPUtility(numExplorer, numActiveAlien, agent_hp_level, 'diamond', 'follow'))
    x22 = round(HPUtility(numExplorer, numActiveAlien, agent_hp_level, 'diamond', 'back'))

    y11 = round(HPUtility(numActiveAlien, numExplorer, agent_hp_level, 'triangle', 'follow'))
    y12 = round(HPUtility(numActiveAlien, numExplorer, agent_hp_level, 'triangle', 'back'))
    y21 = round(HPUtility(numActiveAlien, numExplorer, agent_hp_level, 'diamond', 'follow'))
    y22 = round(HPUtility(numActiveAlien, numExplorer, agent_hp_level, 'diamond', 'back'))
    ...
    explorer_gut_cpt['e11a11e21t'] = GUT_CPT(e1['attacking'], a1['attacking'], e21, 'triangle')
    explorer_gut_cpt['e11a11e21l'] = GUT_CPT(e1['attacking'], a1['attacking'], e21, 'diamond')
    explorer_gut_cpt['e11a12e22t'] = GUT_CPT(e1['attacking'], a1['defending'], e22, 'triangle')
    explorer_gut_cpt['e11a12e22l'] = GUT_CPT(e1['attacking'], a1['defending'], e22, 'diamond')

    explorer_gut_cpt['e12a11e23t'] = GUT_CPT(e1['defending'], a1['attacking'], e23, 'triangle')
    explorer_gut_cpt['e12a11e23l'] = GUT_CPT(e1['defending'], a1['attacking'], e23, 'diamond')
    explorer_gut_cpt['e12a12e24t'] = GUT_CPT(e1['defending'], a1['defending'], e24, 'triangle')
    explorer_gut_cpt['e12a12e24l'] = GUT_CPT(e1['defending'], a1['defending'], e24, 'diamond')
